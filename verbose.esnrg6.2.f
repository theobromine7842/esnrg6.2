...
216   continue
      ...
      ceny=0.
      cenz=0.
      write(6,'(5x,A,3(F9.5,2x))') 'center xyz= ',
     +    x(catnum),y(catnum),z(catnum)
      endif
c------
      print *, 'iatpr=',iatpr
c------
      ...
      gphi(k) = 0.
c------
      print *, 'atomgrp(',k,')=',atomgrp(k)
      invatgrp= 1./float(atomgrp(k))
      print *, 'invatgrp=',invatgrp
c------
      tx_flag = .FALSE.
      ty_flag = .FALSE.
      tz_flag = .FALSE.
      ...
      write(6,*) k,l,n,resname(n),cresid
          phi = 0.
          goto 2230
      endif
      write(6,*) k,l,n,resname(n),cresid
...
c--------
     ...
     +    (tz_flag))) then
      write(6,2225) n,l,x0,y0,z0,r0
      write(6,2225) n,l,xc,yc,zc,r
2225  format(I5,1x,I5,1x,4(f7.2,1x))
      endif
