...
********************************************************
* Number of dcd file was extended to 80 MLTan 03/14/2005
********************
* Set Up Variables *
********************
*
...
*
	...
	parameter (atmax=10000,icdim=80,dmax=50000)
...
*
        write(6,'(5x,A)') ' '
        write(6,'(5x,A)') 'Welcome to GOPHER v.8.1'
        write(6,'(5x,A)') ' '
...
8        write(6,'(5x,A)') 'Enter the number of CHARMM DCD files:'
         ...
         write(6,'(5x,A)') ' '
         if (numdcd.gt.90) then
          write(6,'(A)') 'No more than 90 dcd files can be read!'
          goto 8
         endif
         do 9 i=1,numdcd
...
*
	 ...
	 parameter (atmax=5000,icdim=80,dmax=50000)
